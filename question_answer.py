...
index = pinecone.Index(index_name="my-podcast-index")
...
for i, chunk in enumerate(chunks):
    ...
    index.upsert({f"podcast_chunk_{i}": vector})
...
def answer_question(question):
    ...
    res = index.query(pinecone.Vector(res['data'][0]['embedding']), top_k=1, include_metadata=True)
